...
module.exports = {
  link: [
    ...
    { rel: 'apple-touch-icon', href:'assets/img/touch/apple-touch-icon.png' },

    /** <link> tags for android web app icons **/
    // { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/assets/icon/android-icon-192x192.png' },
    { rel: 'icon', type: 'image/png', sizes: '128x128', href: '/assets/img/icon-128x128.png' },

    /** <link> tags for favicons **/
    // { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/assets/icon/favicon-32x32.png' },
    // { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/assets/icon/favicon-96x96.png' },
    // { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/assets/icon/favicon-16x16.png' },
    // { rel: 'icon', type:'image/png', sizes:'128x128', href:'/assets/images/touch/icon-128x128.png' },
    { rel: 'icon', type: 'image/png', sizes:'192x192', href: '/assets/img/touch/chrome-touch-icon-192x192.png'},
